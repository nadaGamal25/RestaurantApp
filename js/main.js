...
async function getRandomMeals(){
  ...
  for(let i=0;i<20;i++){
    cartona+=`
    <div class="col-md-3 colImg cursor-pointer">
  ...
  for(let i=0;i<1;i++){
    ...
    <div class="row py-4 text-white">
        ...
        <div class="col-md-8">
            ...
            <a href='${meals[i].strSource}' class="btn btn-success mt-2" target='_blank'>Source</a>
            <a href='${meals[i].strYoutube}' class="btn btn-danger mt-2">Youtube</a>
...
async function getCategories(){
  ...
  for(let i=0;i<categories.length;i++){
    cartona+=`
    <div catName=${categories[i].strCategory} class="col-md-3 shadow colImg open">
        <div class="position-relative img-box">
